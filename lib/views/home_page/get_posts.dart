...
//
//   @override
//   State<GetPosts> createState() => _GetPageState();
// }
//
// class _GetPageState extends State<GetPosts> {
              ...
              !isButtonPressed
                  ? Column(
                      ...
                      children: [
                        Text(data),
                        const Text("------------"),
                        Text('isLoading: ${isLoading.toString()}'),
                        const Text("------------"),
                        Text('isButtonPressed: ${isButtonPressed.toString()}'),
                      ],
                    )
                  : isLoading
